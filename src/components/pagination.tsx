...
export const Pagination = ({pageIndex, perPage, totalCount, onPageChange}:PaginationProps) => {
    // Dividino a qtd de registro pelo numero de paginas, caso retorne algo invalido retorna 1
        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6 lg:gap-8">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button onClick={() => onPageChange(pageIndex + 1)} variant={"outline"} className="h-8 w-8 p-0" disabled={pageIndex === totalPages - 1}>
                        <ChevronRight className="h-4 w-4"/>
                        <span className="sr-only">Próxima página</span>
                    </Button>
                    <Button onClick={() => onPageChange(totalPages - 1)} variant={"outline"} className="h-8 w-8 p-0" disabled={pageIndex === totalPages - 1}>
